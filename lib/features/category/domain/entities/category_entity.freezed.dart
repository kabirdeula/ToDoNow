...
abstract class $CategoryEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, int colorValue, String? iconPath});
}
...
class _$CategoryEntityImpl implements _CategoryEntity {
  ...
  @override
  String toString() {
    return 'CategoryEntity(id: $id, name: $name, colorValue: $colorValue, iconPath: $iconPath)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, colorValue, iconPath);
...
abstract class _CategoryEntity implements CategoryEntity {
  const factory _CategoryEntity(
      ...
      final String? iconPath}) = _$CategoryEntityImpl;
