...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<TaskEntity> tasks, bool isSelectionMode});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required final List<TaskEntity> tasks, this.isSelectionMode = false})
      : _tasks = tasks;
  ...
  @override
  String toString() {
    return 'TaskState.loaded(tasks: $tasks, isSelectionMode: $isSelectionMode)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_tasks), isSelectionMode);
...
abstract class _Loaded implements TaskState {
  const factory _Loaded(
      ...
      final bool isSelectionMode}) = _$LoadedImpl;
